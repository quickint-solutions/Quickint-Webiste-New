                        ...
                        <div className="col-lg-12">
                            <div className="case-studies-slider-wrapper">
                                ...
                                >
                                    <div style={{ width: '100%' }}>
                                        <img
                                            src="/assets/images/exact-lims/exactt1.png"
                                            alt="Case Study 1"
                                            style={{
                                                width: '100%',
                                                height: 'auto',
                                    ...
                                    <div style={{ width: '100%' }}>
                                        <img
                                            src="/assets/images/exact-lims/exactt2.png"
                                            alt="Case Study 2"
                                            style={{
                                                width: '100%',
                                                height: 'auto',
                                    ...
                                    <div style={{ width: '100%' }}>
                                        <img
                                            src="/assets/images/exact-lims/exactt3.png"
                                            alt="Case Study 3"
                                            style={{
                                                width: '100%',
                                                height: 'auto',
                                    ...
                                    <div style={{ width: '100%' }}>
                                        <img
                                            src="/assets/images/exact-lims/exactt4.png"
                                            alt="Case Study 4"
                                            style={{
                                                width: '100%',
                                                height: 'auto',
