...
function page() {
    ...
    return (
        <>
                            ...
                            <div className="case-studies-slider-wrapper">
                                ...
                                >
                                    <div style={{ width: '100%', marginTop: '-260px' }}>
                                        <img
                                            src="/assets/images/sony/Sony1.png"
                                            alt="Case Study 1"
                                            style={{
                                                width: '100%',
                                                height: 'auto',
                                    ...
                                    <div style={{ width: '100%', marginTop: '-260px' }}>
                                        <img
                                            src="/assets/images/sony/Sony2.png"
                                            alt="Case Study 2"
                                            style={{
                                                width: '100%',
                                                height: 'auto',
                                    ...
                                    <div style={{ width: '100%', marginTop: '-260px' }}>
                                        <img
                                            src="/assets/images/sony/Sony3.png"
                                            alt="Case Study 3"
                                            style={{
                                                width: '100%',
                                                height: 'auto',
                                    ...
                                    <div style={{ width: '100%', marginTop: '-345px' }}>
                                        <img
                                            src="/assets/images/sony/sony4.png"
                                            alt="Case Study 3"
                                            style={{
                                                width: '100%',
                                                height: 'auto',
            ...
            <div className="case-studies-inner-paragraph-wrapper rts-section-gapTop" style={{ marginTop: '-200px' }}>
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
